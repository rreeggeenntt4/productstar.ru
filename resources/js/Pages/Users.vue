...
/* Тест подключения */
/* import { sayHi, sayBye } from '../MyComponents/logmsg.vue'; */
    ...
    <section class="text-gray-600 body-font">
        <div class="container px-5 py-24 mx-auto">
            <div class="flex flex-col text-center w-full mb-16">
                ...
                <p class="lg:w-2/3 mx-auto leading-relaxed text-base">Пользователи и прогесс прохождения уроков</p>
            </div>
...
<!--             <div class="flex pl-4 mt-4 lg:w-2/3 w-full mx-auto">
                ...
                <button
                    class="flex ml-auto text-white bg-green-500 border-0 py-2 px-6 focus:outline-none hover:bg-green-600 rounded">Button</button>
            </div> -->
        </div>
    </section>
